 ...
 *
 * IDENTITY:
 *   file: "C:\Users\harva\Documents\Trabajos\meetgar\FluxCoreChat\inhost-frontend\src\components\workspace\ConversationListItem.tsx"
 *   type: "component"
 *   layer: "frontend"
 *   domain: "ui"
 *   purpose: "Component for conversation list item"
 *
 * DEPENDENCIES:
 *   internal: ["@/components/common","@/components/ui","@/store","@/store/workspace","@/theme","@/utils/tabHelpers"]
 *   external: ["lucide-react"]
 *   infrastructure: []
 *
 * CONTRACTS:
 *   exports: ["function"]
 *   inputs: "ConversationListItemProps, ConversationListItemProps"
 *   outputs: "JSX.Element"
 *   errors: "None"
 *
 * INTEGRATION:
 ...
 *   uses: ["@/components/common","@/components/ui","@/store","@/store/workspace","@/theme","@/utils/tabHelpers","lucide-react"]
 *   critical: false
 *
 * === DOC_END :: ConversationListItem.tsx ===
 */

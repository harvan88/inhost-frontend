 ...
 *
 * IDENTITY:
 *   file: "C:\Users\harva\Documents\Trabajos\meetgar\FluxCoreChat\inhost-frontend\src\components\chat\ChatHeader.tsx"
 *   type: "component"
 *   layer: "frontend"
 *   domain: "ui"
 *   purpose: "Component for chat header"
 *
 * DEPENDENCIES:
 *   internal: ["@/components/common","@/components/ui","@/hooks/useOverflowDetection","@/store","@/theme"]
 *   external: ["lucide-react"]
 *   infrastructure: []
 *
 * CONTRACTS:
 *   exports: ["function"]
 *   inputs: "ChatHeaderProps, ChatHeaderProps"
 *   outputs: "JSX.Element"
 *   errors: "None"
 *
 * INTEGRATION:
 ...
 *   uses: ["@/components/common","@/components/ui","@/hooks/useOverflowDetection","@/store","@/theme","lucide-react"]
 *   critical: false
 *
 * === DOC_END :: ChatHeader.tsx ===
 */
